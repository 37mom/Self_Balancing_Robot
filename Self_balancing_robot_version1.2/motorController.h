...
#define AIN1				PC2		//logic input FORWARD Motor A
#define AIN2				PC3		//logic input REVERSE Motor A
#define BIN1				PC4		//logic input FORWARD Motor B
#define BIN2				PC6		//logic input REVERSE Motor B
